...
######################################################################
## Figure A1: Unilateral Action and Presidential Candidate Evaluations
######################################################################
## Top Panel
## Support Candidate
## Legalize marijuana Unilateral-Control
pot.cand.control <-
  wtd.t.test(pot.candidate[treatment == "unilateral"],
             pot.candidate[treatment == "control"],
...
pot.cand.legis <-
  wtd.t.test(pot.candidate[treatment == "unilateral"],
             pot.candidate[treatment == "bilateral"],
             oct2015wt1[treatment == "unilateral"],
...
tax.cand.control <-
  wtd.t.test(tax.candidate[treatment == "unilateral"],
             tax.candidate[treatment == "control"],
             oct2015wt1[treatment == "unilateral"],
             oct2015wt1[treatment == "control"],
             samedata = F)$additional[c("Difference", "Std. Err")]
tax.cand.control
...
tax.cand.legis <-
  wtd.t.test(tax.candidate[treatment == "unilateral"],
             tax.candidate[treatment == "bilateral"],
             oct2015wt1[treatment == "unilateral"],
             oct2015wt1[treatment == "bilateral"],
             samedata = F)$additional[c("Difference", "Std. Err")]
tax.cand.legis
...
defense.cand.control <- wtd.t.test(
  defense.candidate[treatment == "unilateral"],
  defense.candidate[treatment == "control"],
  oct2015wt1[treatment == "unilateral"],
  oct2015wt1[treatment == "control"],
  samedata = F
...
defense.cand.legis <- wtd.t.test(
  defense.candidate[treatment == "unilateral"],
  defense.candidate[treatment == "bilateral"],
  oct2015wt1[treatment == "unilateral"],
  oct2015wt1[treatment == "bilateral"],
  samedata = F
)$additional[c("Difference", "Std. Err")]
...
pot.handling.control <-
  wtd.t.test(pot.handling[treatment == "unilateral"],
             pot.handling[treatment == "control"],
             oct2015wt1[treatment == "unilateral"],
             oct2015wt1[treatment == "control"],
             samedata = F)$additional[c("Difference", "Std. Err")]
pot.handling.control
...
pot.handling.legis <-
  wtd.t.test(pot.handling[treatment == "unilateral"],
             pot.handling[treatment == "bilateral"],
             oct2015wt1[treatment == "unilateral"],
             oct2015wt1[treatment == "bilateral"],
             samedata = F)$additional[c("Difference", "Std. Err")]
pot.handling.legis
...
tax.handling.control <-
  wtd.t.test(tax.handling[treatment == "unilateral"],
             tax.handling[treatment == "control"],
             oct2015wt1[treatment == "unilateral"],
             oct2015wt1[treatment == "control"],
             samedata = F)$additional[c("Difference", "Std. Err")]
tax.handling.control
...
tax.handling.legis <-
  wtd.t.test(tax.handling[treatment == "unilateral"],
             tax.handling[treatment == "bilateral"],
             oct2015wt1[treatment == "unilateral"],
             oct2015wt1[treatment == "bilateral"],
             samedata = F)$additional[c("Difference", "Std. Err")]
tax.handling.legis
...
defense.handling.control <- wtd.t.test(
  defense.handling[treatment == "unilateral"],
  defense.handling[treatment == "control"],
  oct2015wt1[treatment == "unilateral"],
  oct2015wt1[treatment == "control"],
  samedata = F
)$additional[c("Difference", "Std. Err")]
...
defense.handling.legis <- wtd.t.test(
  defense.handling[treatment == "unilateral"],
  defense.handling[treatment == "bilateral"],
  oct2015wt1[treatment == "unilateral"],
  oct2015wt1[treatment == "bilateral"],
  samedata = F
)$additional[c("Difference", "Std. Err")]
